...
public class Profesores {
    ...
    public Profesores() throws FileNotFoundException {
    ...
    public ArrayList<Profesor> leer() throws FileNotFoundException {
        profesores.clear();
        try {
            raf.seek(0);
            ...
            for (int i = 0; i < raf.length(); i += 90) {
                ...
                if (existe !='n') {
                    ...
                    if (id == id2) {
                        ...
                        int ext = raf.readInt();
                        p = new Profesor(id, nombre, apellido, ext);
                        break;
                    }
                }
            }
    ...
    public boolean agregar(Profesor p) throws IOException {
        boolean res = false;
